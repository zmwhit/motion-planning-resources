...
In contrast of control problem which closed-loop design state and control variables using feedback in frequency domain and accouting for tracking a reference, motion planning problem open-loop design them in time domain, accouting for avoiding obstacles in configuration space , satisfying physical constraints and then producing the smooth reference
# Take the First Step
